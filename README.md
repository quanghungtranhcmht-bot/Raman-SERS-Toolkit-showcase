...
The application provides transparent, recipe-driven spectral preprocessing, Raman CSV and LightField/FERGIE SPE import, AfterMath PAAX electrochemistry import, interactive visualization, Excel export, processing recommendations, and local reference-library search.

The project is designed around scientific reproducibility: preprocessing parameters remain explicit, raw and processed spectra are preserved separately, estimated baselines can be inspected, and processing settings are stored as reproducible recipes.
EC-SERS Analyzer is a desktop spectral data analysis tool for Raman spectroscopy and electrochemistry data.

The project is designed for EC-SERS analysis of polyphenolic compounds in plant extracts, especially pistachio seed coat extract. Typical target compounds include quercetin, rutin, gallic acid, caffeic acid, ferulic acid, chlorogenic acid, catechin, and epicatechin.
